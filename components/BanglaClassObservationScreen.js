        ...
        <View style={styles.container}>
          ...
          <ScrollView>
            ...
            <View style={{ padding: 10 }}>
                <Text style={styles.bigRedText}>Basic Data:</Text>
            ...
            <View style={{ padding: 10 }}>
              ...
              <View style={{ flexDirection: "row", padding: 10 }}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={{ padding: 5 }}>
                    4. Based on priority area, mention indicator for no or
                    partial no.
                  </Text>
                  <Text style={{ padding: 5 }}>
                  ...
                  <Text style={{ padding: 5 }}>
                    6. Mention RoomToRead action, if needed.3. Mention 2-3
                    better way for Bangla reading.
                  </Text>
                </View>
                <View style={{ flex: 1 }}>
            ...
            <View style={{ padding: 10 }}>
              ...
              <View style={{ padding: 5 }}>
                ...
                <View style={{ flexDirection: "row" }}>
                  ...
                  <View style={{ flex: 1, padding: 2 }}>
                    <Text>
                      Teacher reading is correct for all letter, letter and
                      parts of word, also allowing student for practice.(if
                      applicable)
                    </Text>
                  </View>
                  <View style={{ flex: 1, padding: 2 }}>
                ...
                <View style={{ flexDirection: "row" }}>
                  ...
                  <View style={{ flex: 1, padding: 2 }}>
                    <Text>
                      ...
                      pronuntuation and action), and allow student to
                ...
                <View style={{ flexDirection: "row" }}>
                  ...
                  <View style={{ flex: 1, padding: 2 }}>
                    <Text>
                      The teacher ask suplimentory question for correct answer
                      or teaches to find answer.(if applicable)
                    </Text>
                  </View>
                  <View style={{ flex: 1, padding: 2 }}>
                    <Text>3</Text>
                ...
                <View style={{ flexDirection: "row" }}>
                  ...
                  <View style={{ flex: 1, padding: 2 }}>
                    <Text>
                      The teacher involves all boy-girl, physically challaged
                      and weak student in learning and testing.
                    </Text>
                  </View>
                  <View style={{ flex: 1, padding: 2 }}>
                    <Text>1</Text>
